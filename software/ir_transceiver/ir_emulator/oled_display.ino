...
void oledDisplayRender(String command) {
  ...
  if (current_screen == 0) { // MENU SCREEN
      ...
      if ((command == "/up")) { // up button clicked - jump to previous menu item
      ...
      else if ((command == "/down")) { // down button clicked - jump to next menu item
